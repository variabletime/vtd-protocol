...
contract MockState is Setters {
    ...
    function setEpochTimestampE(uint256 timestamp) external {
        _state.epoch.previousEpochTimestamp = timestamp;
    }

    function setEpochAdjustmentAmountE(uint256 adjustmentAmount) external {
        super.setEpochAdjustmentAmount(adjustmentAmount);
    }
